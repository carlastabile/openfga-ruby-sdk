...
module OpenFga
  class Assertion
    ...
    # @param [Object] tuple_key Value to be assigned
    def tuple_key=(tuple_key)
      if tuple_key.nil?
        fail ArgumentError, 'tuple_key cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] expectation Value to be assigned
    def expectation=(expectation)
      if expectation.nil?
        fail ArgumentError, 'expectation cannot be nil'
      end
    ...
    def contextual_tuples=(contextual_tuples)
      ...
      if contextual_tuples.length > 20
        fail ArgumentError, 'invalid value for "contextual_tuples", number of items must be less than or equal to 20.'
      end
