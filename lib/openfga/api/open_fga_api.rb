...
module OpenFga
  class OpenFgaApi
    ...
    # @param body [BatchCheckRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(BatchCheckResponse, Integer, Hash)>] BatchCheckResponse data, response status code and response headers
    ...
    # @option opts [String] :name The name parameter instructs the API to only include results that match that name.Multiple results may be returned. Only exact matches will be returned; substring matches and regexes will not be evaluated
